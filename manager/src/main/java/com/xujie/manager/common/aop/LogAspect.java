...
public class LogAspect {
  ...
  @Resource private OperLogDomainService operLogDomainService;
  ...
  public Object around(ProceedingJoinPoint proceedingJoinPoint) {
    ...
    OperLogBO operLogBO =
        OperLogBO.builder()
            ...
            .methodName(
                String.join(
                    ".", signature.getDeclaringType().getPackageName(), signature.getName()))
   ...
   * @throws Exception
   */
  public WebLog getAspectLogDescription(JoinPoint joinPoint) throws Exception {

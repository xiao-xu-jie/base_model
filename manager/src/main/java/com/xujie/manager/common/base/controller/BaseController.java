...
public abstract class BaseController<
  ...
  public Result<Page<QueryRes>> selectPage(
      @ModelAttribute("entity") QueryReq queryReq,
      @RequestParam(name = "pageNum", required = true) Integer pageNum,
      @RequestParam(name = "pageSize", required = true) Integer pageSize) {
    Page<BO> PageList =
        baseDomainService.getPageList(baseConvert.convertQueryDTO2BO(queryReq), pageNum, pageSize);

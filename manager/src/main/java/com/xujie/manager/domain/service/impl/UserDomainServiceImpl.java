...
public class UserDomainServiceImpl implements UserDomainService {
    ...
    public void addUser(UserBO userBO) {
        ...
        ConditionCheck.trueAndThrow(success, new CustomException("添加用户失败"));
    }
    ...
    public void deleteUser(Long id) {
        ...
        ConditionCheck.trueAndThrow(b, new CustomException("删除用户失败"));
    }

    @Override
    public void updateUser(UserBO userBO) {
        boolean b = baseService.updateUser(userBO.getId(), userConvert.convertBO2DO(userBO));
        ConditionCheck.trueAndThrow(b, new CustomException("更新用户失败"));
    }
